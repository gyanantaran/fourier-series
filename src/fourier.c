...
// author: vishalpaudel
// 2024-04-06
// Note: this contains helper functions to calculate fourier series for a given sketch
...
const double DELTA_TIME = 0.000001;
...
Vector2 sampleSketch(struct Sketch * sketch, double t)
{
    ...
    {   // doing linear interpolation between ceil and floor indexes
